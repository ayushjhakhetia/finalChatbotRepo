...
public class QueryResult {
	...
	private List<FullfillmentMessages> fulfillmentMessages;
	...
	@JsonProperty("fulfillmentMessages")
	public List<FullfillmentMessages> getFulfillmentMessages() {
		return fulfillmentMessages;
	}

	@JsonProperty("fulfillmentMessages")
	public void setFulfillmentMessages(List<FullfillmentMessages> fulfillmentMessages) {
